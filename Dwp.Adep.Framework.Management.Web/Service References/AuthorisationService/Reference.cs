...
namespace Dwp.Adep.Framework.Management.Web.AuthorisationService {
    ...
    public interface IAuthorisationService {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(Dwp.Adep.Framework.Management.Web.AuthorisationService.ServiceErrorFault), Action="http://tempuri.org/IAuthorisationService/GetUserAuthorisationInfoServiceErrorFaul" +
            "tFault", Name="ServiceErrorFault", Namespace="http://schemas.datacontract.org/2004/07/Dwp.Adep.Framework.Management.WebServices" +
            ".FaultContracts")]
        [System.ServiceModel.FaultContractAttribute(typeof(Dwp.Adep.Framework.Management.Web.AuthorisationService.AuthorisationFailureFault), Action="http://tempuri.org/IAuthorisationService/GetUserAuthorisationInfoAuthorisationFai" +
            ...
            ".FaultContracts")]
        Dwp.Adep.Framework.Management.Web.AuthorisationService.AuthorisationDC GetUserAuthorisationInfo(string token, string appID, string[] roles);
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(Dwp.Adep.Framework.Management.Web.AuthorisationService.AuthorisationFailureFault), Action="http://tempuri.org/IAuthorisationService/GetUserRolesAuthorisationFailureFaultFau" +
            ...
            ".FaultContracts")]
        [System.ServiceModel.FaultContractAttribute(typeof(Dwp.Adep.Framework.Management.Web.AuthorisationService.ServiceErrorFault), Action="http://tempuri.org/IAuthorisationService/GetUserRolesServiceErrorFaultFault", Name="ServiceErrorFault", Namespace="http://schemas.datacontract.org/2004/07/Dwp.Adep.Framework.Management.WebServices" +
            ".FaultContracts")]
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(Dwp.Adep.Framework.Management.Web.AuthorisationService.ServiceErrorFault), Action="http://tempuri.org/IAuthorisationService/GetUserApplicationInfoServiceErrorFaultF" +
            "ault", Name="ServiceErrorFault", Namespace="http://schemas.datacontract.org/2004/07/Dwp.Adep.Framework.Management.WebServices" +
            ".FaultContracts")]
        [System.ServiceModel.FaultContractAttribute(typeof(Dwp.Adep.Framework.Management.Web.AuthorisationService.AuthorisationFailureFault), Action="http://tempuri.org/IAuthorisationService/GetUserApplicationInfoAuthorisationFailu" +
            ...
            ".FaultContracts")]
        Dwp.Adep.Framework.Management.Web.AuthorisationService.StaffAccessDC[] GetUserApplicationInfo(string currentUser, string user, string appID, string overrideID, string userID, string[] roles);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IAuthorisationServiceChannel : Dwp.Adep.Framework.Management.Web.AuthorisationService.IAuthorisationService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AuthorisationServiceClient : System.ServiceModel.ClientBase<Dwp.Adep.Framework.Management.Web.AuthorisationService.IAuthorisationService>, Dwp.Adep.Framework.Management.Web.AuthorisationService.IAuthorisationService {
        ...
        public Dwp.Adep.Framework.Management.Web.AuthorisationService.AuthorisationDC GetUserAuthorisationInfo(string token, string appID, string[] roles) {
        ...
        public Dwp.Adep.Framework.Management.Web.AuthorisationService.StaffAccessDC[] GetUserApplicationInfo(string currentUser, string user, string appID, string overrideID, string userID, string[] roles) {
