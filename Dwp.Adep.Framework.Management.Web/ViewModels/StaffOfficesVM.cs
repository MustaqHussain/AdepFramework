...
{
    public partial class StaffOfficesVM
    {
    	public StaffOfficesModel StaffOfficesItem { get; set; }
        ...
        public StaffOfficesAccessContext AccessContext { get; set; }
    	
    }
    
    public enum StaffOfficesAccessContext
    {
        Create,
        View,
        Edit
