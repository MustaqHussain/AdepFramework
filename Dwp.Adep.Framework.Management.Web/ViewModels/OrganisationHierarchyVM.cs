...
{
    public partial class OrganisationHierarchyVM
    {
    	public OrganisationHierarchyModel OrganisationHierarchyItem { get; set; }
        ...
        public OrganisationHierarchyAccessContext AccessContext { get; set; }
    	
    }
    
    public enum OrganisationHierarchyAccessContext
    {
        Create,
        View,
        Edit
