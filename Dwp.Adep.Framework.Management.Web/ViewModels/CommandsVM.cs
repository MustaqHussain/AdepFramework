...
{
    public partial class CommandsVM
    {
    	public CommandsModel CommandsItem { get; set; }
        ...
        public CommandsAccessContext AccessContext { get; set; }
    	
    }
    
    public enum CommandsAccessContext
    {
        Create,
        View,
        Edit
