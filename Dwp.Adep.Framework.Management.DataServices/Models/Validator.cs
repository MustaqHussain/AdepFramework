...
namespace Dwp.Adep.Framework.Management.DataServices.Models
{
    public partial class Validator
    {
        ...
        {
            if (previousValue != null && previousValue.Validators.Contains(this))
            {
                previousValue.Validators.Remove(this);
            }
    
            if (Staff != null)
            {
                if (!Staff.Validators.Contains(this))
                {
                    Staff.Validators.Add(this);
                }
