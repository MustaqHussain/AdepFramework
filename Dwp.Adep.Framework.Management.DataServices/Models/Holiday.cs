...
{
    public partial class Holiday : IAuditable, IActiveAware 
    {
        ...
        {
            if (previousValue != null && previousValue.Holiday.Contains(this))
            {
            ...
            {
                if (!Organisation.Holiday.Contains(this))
                {
                    Organisation.Holiday.Add(this);
                }
