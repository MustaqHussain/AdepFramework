...
namespace Dwp.Adep.Framework.Management.DataServices.Models
{
    public partial class Organisation : IAuditable, IActiveAware 
    {
        ...
        public virtual ICollection<Country> Country
        {
            get
            {
                if (_country == null)
                {
                    ...
                    newCollection.CollectionChanged += FixupCountry;
                    _country = newCollection;
                }
                return _country;
            }
            set
            {
                ...
                {
                    var previousValue = _country as FixupCollection<Country>;
                    if (previousValue != null)
                    {
                        previousValue.CollectionChanged -= FixupCountry;
                    }
                    _country = value;
                    var newValue = value as FixupCollection<Country>;
                    if (newValue != null)
                    {
                        newValue.CollectionChanged += FixupCountry;
                    }
                }
            }
        }
        private ICollection<Country> _country;
        ...
        public virtual ICollection<Holiday> Holiday
        {
            get
            {
                if (_holiday == null)
                {
                    var newCollection = new FixupCollection<Holiday>();
                    newCollection.CollectionChanged += FixupHoliday;
                    _holiday = newCollection;
                }
                return _holiday;
            }
            set
            {
                if (!ReferenceEquals(_holiday, value))
                {
                    var previousValue = _holiday as FixupCollection<Holiday>;
                    if (previousValue != null)
                    {
                        previousValue.CollectionChanged -= FixupHoliday;
                    }
                    _holiday = value;
                    var newValue = value as FixupCollection<Holiday>;
                    if (newValue != null)
                    {
                        newValue.CollectionChanged += FixupHoliday;
                    }
                }
            }
        }
        private ICollection<Holiday> _holiday;
        ...
        private void FixupCountry(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (e.NewItems != null)
            {
        ...
        private void FixupHoliday(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (e.NewItems != null)
            {
                foreach (Holiday item in e.NewItems)
                {
                    item.Organisation = this;
                }
            }
            ...
            if (e.OldItems != null)
            {
                foreach (Holiday item in e.OldItems)
                {
                    if (ReferenceEquals(item.Organisation, this))
                    {
                        item.Organisation = null;
