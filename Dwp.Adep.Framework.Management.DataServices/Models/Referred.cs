...
namespace Dwp.Adep.Framework.Management.DataServices.Models
{
    public partial class Referred
    {
        ...
        {
            if (previousValue != null && previousValue.Referred.Contains(this))
            {
                previousValue.Referred.Remove(this);
            }
    
            if (Organisation != null)
            {
                if (!Organisation.Referred.Contains(this))
                {
                    Organisation.Referred.Add(this);
                }
