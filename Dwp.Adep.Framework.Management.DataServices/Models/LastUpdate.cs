...
namespace Dwp.Adep.Framework.Management.DataServices.Models
{
    public partial class LastUpdate
    {
        ...
        {
            if (previousValue != null && previousValue.LastUpdate.Contains(this))
            {
                previousValue.LastUpdate.Remove(this);
            }
    
            if (Organisation != null)
            {
                if (!Organisation.LastUpdate.Contains(this))
                {
                    Organisation.LastUpdate.Add(this);
                }
