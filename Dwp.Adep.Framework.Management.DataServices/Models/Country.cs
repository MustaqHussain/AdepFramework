...
{
    public partial class Country : IAuditable, IActiveAware 
    {
        ...
        {
            if (previousValue != null && previousValue.Country.Contains(this))
            {
            ...
            {
                if (!Organisation.Country.Contains(this))
                {
                    Organisation.Country.Add(this);
                }
