    ...
    public partial class AdminService
    {
        #region Behaviour for Organisation
            ...
            public OrganisationVMDC CreateOrganisation(string currentUser, string user, string appID, string overrideID, OrganisationDC dc)
            {
                ...
                return CreateOrganisation(currentUser, user, appID, overrideID, dc, dataRepository, uow);
            }
            ...
            public OrganisationVMDC CreateOrganisation(string currentUser, string user, string appID, string overrideID, OrganisationDC dc, IRepository<Organisation> dataRepository, IUnitOfWork uow)
            {
                try
                {
    		...
    		
            {
                try
                {
                    ...
                    using (uow)
                    {
    					...
    					IEnumerable<OrganisationType> organisationTypeList = organisationTypeRepository.GetAll(x => new {x.Name});
            ...
            public List<OrganisationDC> GetAllOrganisation(string currentUser, string user, string appID, string overrideID, bool includeInActive)
            {
    			...
    			// Call overload with injected objects
                return GetAllOrganisation(currentUser, user, appID, overrideID, includeInActive, specification, dataRepository, uow);
            }
            ...
            /// <param name="uow"></param>
            /// <returns></returns>
            public List<OrganisationDC> GetAllOrganisation(string currentUser, string user, string appID, string overrideID,  bool includeInActive, ISpecification<Organisation> specification, IRepository<Organisation> dataRepository, IUnitOfWork uow)
            {
                try
                {
    				#region Parameter validation
                    ...
                    using (uow)
                    {
                        ...
                        List<OrganisationDC> destinations = Mapper.Map<IEnumerable<Organisation>, List<OrganisationDC>>(dataEntities);
    		...
    		public OrganisationSearchVMDC SearchOrganisation(string currentUser, string user, string appID, string overrideID, OrganisationSearchCriteriaDC searchCriteria, int page, int pageSize, bool includeInActive)
            {
    			...
    			// Call overload with injected objects
                return SearchOrganisation(currentUser, user, appID, overrideID, searchCriteria, page, pageSize, includeInActive, specification, dataRepository, uow);
    		}
            ...
            public OrganisationVMDC UpdateOrganisation(string currentUser, string user, string appID, string overrideID, OrganisationDC dc)
            {
    			...
    			// Call overload with injected objects
                return UpdateOrganisation(currentUser, user, appID, overrideID, dc, dataRepository, uow);
            }
            ...
            /// <param name="dataRepository"></param>
            /// <param name="uow"></param>
            public OrganisationVMDC UpdateOrganisation(string currentUser, string user, string appID, string overrideID, OrganisationDC dc, IRepository<Organisation> dataRepository, IUnitOfWork uow)
            {
                try
                {
    				#region Parameter validation
            ...
            public void DeleteOrganisation(string currentUser, string user, string appID, string overrideID, string code, string lockID)
            {
    			...
    			// Call overload with injected objects
                DeleteOrganisation(currentUser, user, appID, overrideID, code, lockID, dataRepository, uow);
            }
            ...
            /// <param name="dataRepository"></param>
            /// <param name="uow"></param>
            public void DeleteOrganisation(string currentUser, string user, string appID, string overrideID, string code, string lockID, IRepository<Organisation> dataRepository, IUnitOfWork uow)
            {
                try
                {
    				#region Parameter validation
