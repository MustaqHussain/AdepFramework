    ...
    public partial class AdminService
    {
        #region Behaviour for StaffOrganisation
            ...
            public StaffOrganisationVMDC CreateStaffOrganisation(string currentUser, string user, string appID, string overrideID, StaffOrganisationDC dc)
            {
                ...
                return CreateStaffOrganisation(currentUser, user, appID, overrideID, dc, dataRepository, uow);
            }
            ...
            public StaffOrganisationVMDC CreateStaffOrganisation(string currentUser, string user, string appID, string overrideID, StaffOrganisationDC dc, IRepository<StaffOrganisation> dataRepository, IUnitOfWork uow)
            {
                try
                {
                ...
                try
                {
                    ...
                    using (uow)
                    {
    					...
    					if (!string.IsNullOrEmpty(code))
    					{
    	                    ...
    	                    destination = Mapper.Map<StaffOrganisation, StaffOrganisationDC>(dataEntity);
    					}
    
    					IEnumerable<Staff> staffList = staffRepository.GetAll(x => new {x.StaffNumber});
    					IEnumerable<Organisation> organisationList = organisationRepository.GetAll(x => new {x.Name});
    					...
    					List<OrganisationDC> organisationDestinationList = Mapper.Map<List<OrganisationDC>>(organisationList);
            ...
            public List<StaffOrganisationDC> GetAllStaffOrganisation(string currentUser, string user, string appID, string overrideID)
            {
                ...
                return GetAllStaffOrganisation(currentUser, user, appID, overrideID, specification, dataRepository, uow);
            }
            ...
            /// <param name="uow"></param>
            /// <returns></returns>
            public List<StaffOrganisationDC> GetAllStaffOrganisation(string currentUser, string user, string appID, string overrideID, ISpecification<StaffOrganisation> specification, IRepository<StaffOrganisation> dataRepository, IUnitOfWork uow)
            {
                try
                {
    				#region Parameter validation
                    ...
                    using (uow)
                    {
    					...
    					System.Linq.Expressions.Expression<Func<StaffOrganisation, Object>> sortExpression = x => x.IsDefault;
                        ...
                        List<StaffOrganisationDC> destinations = Mapper.Map<IEnumerable<StaffOrganisation>, List<StaffOrganisationDC>>(dataEntities);
    		...
    		public StaffOrganisationSearchVMDC SearchStaffOrganisation(string currentUser, string user, string appID, string overrideID, StaffOrganisationSearchCriteriaDC searchCriteria, int page, int pageSize)
            {
    			...
    			// Call overload with injected objects
                return SearchStaffOrganisation(currentUser, user, appID, overrideID, searchCriteria, page, pageSize, specification, dataRepository, uow);
    		}
            ...
            /// <returns></returns>
    		public StaffOrganisationSearchVMDC SearchStaffOrganisation(string currentUser, string user, string appID, string overrideID, StaffOrganisationSearchCriteriaDC searchCriteria, int page, int pageSize, 
    		ISpecification<StaffOrganisation> specification, IRepository<StaffOrganisation> dataRepository, IUnitOfWork uow)
            {
    		    try
                {
    				#region Parameter validation
                    ...
                    using (uow)
                    {
    					...
    					// Convert to data contracts
                        List<StaffOrganisationSearchMatchDC> destinations = Mapper.Map<IEnumerable<StaffOrganisation>, List<StaffOrganisationSearchMatchDC>>(dataEntities);
            ...
            public StaffOrganisationVMDC UpdateStaffOrganisation(string currentUser, string user, string appID, string overrideID, StaffOrganisationDC dc)
            {
    			...
    			// Call overload with injected objects
                return UpdateStaffOrganisation(currentUser, user, appID, overrideID, dc, dataRepository, uow);
            }
            ...
            public void DeleteStaffOrganisation(string currentUser, string user, string appID, string overrideID, string code, string lockID)
            {
    			...
    			// Call overload with injected objects
                DeleteStaffOrganisation(currentUser, user, appID, overrideID, code, lockID, dataRepository, uow);
            }
