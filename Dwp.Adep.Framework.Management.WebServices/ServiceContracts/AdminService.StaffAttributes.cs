    ...
    public partial class AdminService
    {
        #region Behaviour for StaffAttributes
            ...
            public StaffAttributesVMDC CreateStaffAttributes(string currentUser, string user, string appID, string overrideID, StaffAttributesDC dc)
            {
                ...
                return CreateStaffAttributes(currentUser, user, appID, overrideID, dc, dataRepository, uow);
            }
            ...
            public StaffAttributesVMDC CreateStaffAttributes(string currentUser, string user, string appID, string overrideID, StaffAttributesDC dc, IRepository<StaffAttributes> dataRepository, IUnitOfWork uow)
            {
                try
                {
                ...
                try
                {
                    ...
                    using (uow)
                    {
    					...
    					if (!string.IsNullOrEmpty(code))
    					{
    	                    ...
    	                    destination = Mapper.Map<StaffAttributes, StaffAttributesDC>(dataEntity);
    					}
            ...
            public List<StaffAttributesDC> GetAllStaffAttributes(string currentUser, string user, string appID, string overrideID, bool includeInActive)
            {
    			...
    			// Call overload with injected objects
                return GetAllStaffAttributes(currentUser, user, appID, overrideID, includeInActive, specification, dataRepository, uow);
            }
            ...
            /// <param name="uow"></param>
            /// <returns></returns>
            public List<StaffAttributesDC> GetAllStaffAttributes(string currentUser, string user, string appID, string overrideID,  bool includeInActive, ISpecification<StaffAttributes> specification, IRepository<StaffAttributes> dataRepository, IUnitOfWork uow)
            {
                try
                {
    				#region Parameter validation
                    ...
                    using (uow)
                    {
                        ...
                        if (!includeInActive)
                        {
                            ISpecification<StaffAttributes> isActiveSpecification = new Specification<StaffAttributes>(x => x.IsActive == true);
                            specification = specification.And(isActiveSpecification);
                        }
    
    					// Set default sort expression
    					System.Linq.Expressions.Expression<Func<StaffAttributes, Object>> sortExpression = x => x.LookupValue;
                        ...
                        List<StaffAttributesDC> destinations = Mapper.Map<IEnumerable<StaffAttributes>, List<StaffAttributesDC>>(dataEntities);
            ...
            /// <returns></returns>
    		public StaffAttributesSearchVMDC SearchStaffAttributes(string currentUser, string user, string appID, string overrideID, StaffAttributesSearchCriteriaDC searchCriteria, int page, int pageSize, bool includeInActive,
    		ISpecification<StaffAttributes> specification, IRepository<StaffAttributes> dataRepository, IUnitOfWork uow)
            {
    		    try
                {
    				#region Parameter validation
                    ...
                    using (uow)
                    {
    					...
    					// Convert to data contracts
                        List<StaffAttributesSearchMatchDC> destinations = Mapper.Map<IEnumerable<StaffAttributes>, List<StaffAttributesSearchMatchDC>>(dataEntities);
            ...
            public StaffAttributesVMDC UpdateStaffAttributes(string currentUser, string user, string appID, string overrideID, StaffAttributesDC dc)
            {
    			...
    			// Call overload with injected objects
                return UpdateStaffAttributes(currentUser, user, appID, overrideID, dc, dataRepository, uow);
            }
            ...
            public void DeleteStaffAttributes(string currentUser, string user, string appID, string overrideID, string code, string lockID)
            {
    			...
    			// Call overload with injected objects
                DeleteStaffAttributes(currentUser, user, appID, overrideID, code, lockID, dataRepository, uow);
            }
