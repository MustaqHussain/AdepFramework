    ...
    public partial class AdminService
    {
        #region Behaviour for Staff
            ...
            public StaffVMDC CreateStaff(string currentUser, string user, string appID, string overrideID, StaffDC dc)
            {
                ...
                return CreateStaff(currentUser, user, appID, overrideID, dc, dataRepository, uow);
            }
            ...
            public StaffVMDC CreateStaff(string currentUser, string user, string appID, string overrideID, StaffDC dc, IRepository<Staff> dataRepository, IUnitOfWork uow)
            {
                try
                {
                ...
                try
                {
                    ...
                    using (uow)
                    {
    					...
    					if (!string.IsNullOrEmpty(code))
    					{
    	                    ...
    	                    destination = Mapper.Map<Staff, StaffDC>(dataEntity);
    					}
    
    					IEnumerable<Grade> gradeList = gradeRepository.GetAll(x => new {x.Grade1});
    
    					List<GradeDC> gradeDestinationList = Mapper.Map<List<GradeDC>>(gradeList);
            ...
            public List<StaffDC> GetAllStaff(string currentUser, string user, string appID, string overrideID, bool includeInActive)
            {
    			...
    			// Call overload with injected objects
                return GetAllStaff(currentUser, user, appID, overrideID, includeInActive, specification, dataRepository, uow);
            }
            ...
            /// <param name="uow"></param>
            /// <returns></returns>
            public List<StaffDC> GetAllStaff(string currentUser, string user, string appID, string overrideID,  bool includeInActive, ISpecification<Staff> specification, IRepository<Staff> dataRepository, IUnitOfWork uow)
            {
                try
                {
    				#region Parameter validation
                    ...
                    using (uow)
                    {
                        ...
                        if (!includeInActive)
                        {
                            ISpecification<Staff> isActiveSpecification = new Specification<Staff>(x => x.IsActive == true);
                            specification = specification.And(isActiveSpecification);
                        }
    
    					// Set default sort expression
    					System.Linq.Expressions.Expression<Func<Staff, Object>> sortExpression = x => x.StaffNumber;
                        ...
                        List<StaffDC> destinations = Mapper.Map<IEnumerable<Staff>, List<StaffDC>>(dataEntities);
    		...
    		public StaffSearchVMDC SearchStaff(string currentUser, string user, string appID, string overrideID, StaffSearchCriteriaDC searchCriteria, int page, int pageSize, bool includeInActive)
            {
    			...
    			// Call overload with injected objects
                return SearchStaff(currentUser, user, appID, overrideID, searchCriteria, page, pageSize, includeInActive, specification, dataRepository, uow);
    		}
            ...
            /// <returns></returns>
    		public StaffSearchVMDC SearchStaff(string currentUser, string user, string appID, string overrideID, StaffSearchCriteriaDC searchCriteria, int page, int pageSize, bool includeInActive,
    		ISpecification<Staff> specification, IRepository<Staff> dataRepository, IUnitOfWork uow)
            {
    		    try
                {
    				#region Parameter validation
                    ...
                    using (uow)
                    {
    					...
    					// Convert to data contracts
                        List<StaffSearchMatchDC> destinations = Mapper.Map<IEnumerable<Staff>, List<StaffSearchMatchDC>>(dataEntities);
            ...
            public void DeleteStaff(string currentUser, string user, string appID, string overrideID, string code, string lockID)
            {
    			...
    			// Call overload with injected objects
                DeleteStaff(currentUser, user, appID, overrideID, code, lockID, dataRepository, uow);
            }
            ...
            /// <param name="dataRepository"></param>
            /// <param name="uow"></param>
            public void DeleteStaff(string currentUser, string user, string appID, string overrideID, string code, string lockID, IRepository<Staff> dataRepository, IUnitOfWork uow)
            {
                try
                {
    				#region Parameter validation
